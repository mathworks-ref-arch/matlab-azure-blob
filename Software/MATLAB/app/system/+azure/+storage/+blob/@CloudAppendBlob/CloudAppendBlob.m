classdef CloudAppendBlob < azure.object
    ...
    methods
        %% Constructor
        function obj = CloudAppendBlob(varargin)
            ...
            switch(nargin)
                case 1
                    ...
                    % e.g.  blob = azure.storage.blob.CloudAppendBlob(mySAS_StorageUri);
                    % Note, the LocalUploadPath is not set in this case
                    sURI = varargin{1};
                    if isa(sURI,'azure.storage.StorageUri')
                        obj.Handle = com.microsoft.azure.storage.blob.CloudAppendBlob(sURI.Handle);
                ...
                case 2
                    ...
                    % e.g.  blob = azure.storage.blob.CloudAppendBlob(azContainer, blobname);
                    % Note, the LocalUploadPath is not set in this case
                    ...
                    obj.Handle = container.Handle.getAppendBlobReference(obj.Name);


                case 3
                    % e.g.  blob = azure.storage.blob.CloudAppendBlob(azContainer, 'mydir/myAzureblobname.mat', '/my/local/path/SampleData.mat');
