function to = delete(tableEntity, varargin)
...
if numel(tableEntity)==1
    ...
    to = com.microsoft.azure.storage.table.TableOperation.delete(tableEntity.Handle);
else
    ...
    for tCount = 1:numel(tableEntity)
        to.delete(tableEntity(tCount).Handle);
    end
end
