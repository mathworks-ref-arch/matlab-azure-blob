function to = insertOrReplace(tableEntity, varargin)
...
if numel(tableEntity)==1
    ...
    to = com.microsoft.azure.storage.table.TableOperation.insertOrReplace(tableEntity.Handle);
else
    ...
    for tCount = 1:numel(tableEntity)
        to.insertOrReplace(tableEntity(tCount).Handle);
    end
end
