function to = insert(tableEntity, echoFlag, varargin)
...
if numel(tableEntity)==1
    ...
    to = com.microsoft.azure.storage.table.TableOperation.insert(tableEntity.Handle, echoFlag);
else
    ...
    for tCount = 1:numel(tableEntity)
        to.insert(tableEntity(tCount).Handle, echoFlag);
    end
end
